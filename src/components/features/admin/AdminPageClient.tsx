...
export function AdminPageClient({
  ...
  const showDeleteConfirmModal = useCallback(
    (id: string) => {
      showModal({
        title: t("pages.admin.dashboard.deleteConfirmTitle"),
        message: t("pages.admin.dashboard.deleteConfirm"),
    ...
    [t, showModal, closeModal, handleConfirmDelete]
  );
              ...
              {templates.map((template) => (
                ...
                >
                  ...
                  <td className="p-4 flex items-center gap-2">
                    ...
                    <button
                      onClick={() => showDeleteConfirmModal(template.id)}
