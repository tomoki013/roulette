...
const RoulettePreview = forwardRef<HTMLDivElement, RoulettePreviewProps>(({
    ...
    const renderResult = () => {
        ...
        return (
            ...
            >
                <p className="text-white/80" style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.5)' }}>
                    {t('roulette.result.title')}
                </p>
                <p className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-400 my-2" 
