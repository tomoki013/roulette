  ...
  return (
    ...
    >
      ...
      {errorMessage && (
        <div
          role="alert"
          className="mb-6 rounded-lg border border-red-500/80 bg-red-900/50 p-4 shadow-lg"
        >
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="flex items-start space-x-3">
          <input
            ...
            id="agreeToTerms"
            className="h-4 w-4 mt-1 rounded border-gray-300 text-yellow-400 focus:ring-yellow-400"
          />
        ...
        <div>
          <button
            type="submit"
            className="w-full px-6 py-3 bg-gradient-to-r from-yellow-400 to-orange-500 text-white rounded-lg hover:from-yellow-500 hover:to-orange-600 transition-colors font-semibold disabled:opacity-50"
